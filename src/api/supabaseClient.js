...
const STORAGE_BUCKET = env?.VITE_SUPABASE_STORAGE_BUCKET || 'books';
const EDGE_FUNCTION_URL = env?.VITE_SUPABASE_EDGE_FUNCTION_URL || null;
...
export const createSupabaseAdminClient = () => null;

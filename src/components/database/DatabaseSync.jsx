...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE public.books
            ADD CONSTRAINT books_created_by_fkey FOREIGN KEY (created_by) REFERENCES auth.users(id);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'books_updated_by_fkey'
    ) THEN
        ALTER TABLE public.books
            ADD CONSTRAINT books_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES auth.users(id);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'purchases_created_by_fkey'
    ) THEN
        ALTER TABLE public.purchases
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'purchases_book_id_fkey'
    ) THEN
        ALTER TABLE public.purchases
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'purchases_buyer_user_id_fkey'
    ) THEN
        ALTER TABLE public.purchases
            ADD CONSTRAINT purchases_buyer_user_id_fkey FOREIGN KEY (buyer_user_id) REFERENCES public.users(id);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'purchases_seller_user_id_fkey'
    ) THEN
        ALTER TABLE public.purchases
            ADD CONSTRAINT purchases_seller_user_id_fkey FOREIGN KEY (seller_user_id) REFERENCES public.users(id);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'reviews_created_by_fkey'
    ) THEN
        ALTER TABLE public.reviews
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'resale_listings_created_by_fkey'
    ) THEN
        ALTER TABLE public.resale_listings
            ADD CONSTRAINT resale_listings_created_by_fkey FOREIGN KEY (created_by) REFERENCES auth.users(id);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'resale_listings_book_id_fkey'
    ) THEN
        ALTER TABLE public.resale_listings
            ADD CONSTRAINT resale_listings_book_id_fkey FOREIGN KEY (book_id) REFERENCES public.books(id);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'resale_listings_seller_user_id_fkey'
    ) THEN
        ALTER TABLE public.resale_listings
            ADD CONSTRAINT resale_listings_seller_user_id_fkey FOREIGN KEY (seller_user_id) REFERENCES public.users(id);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'resale_listings_original_purchase_id_fkey'
    ) THEN
        ALTER TABLE public.resale_listings
            ADD CONSTRAINT resale_listings_original_purchase_id_fkey FOREIGN KEY (original_purchase_id) REFERENCES public.purchases(id);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'ai_recommendations_created_by_fkey'
    ) THEN
        ALTER TABLE public.ai_recommendations
            ADD CONSTRAINT ai_recommendations_created_by_fkey FOREIGN KEY (created_by) REFERENCES auth.users(id);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'ai_recommendations_user_id_fkey'
    ) THEN
        ALTER TABLE public.ai_recommendations
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'user_book_data_created_by_fkey'
    ) THEN
        ALTER TABLE public.user_book_data
            ADD CONSTRAINT user_book_data_created_by_fkey FOREIGN KEY (created_by) REFERENCES auth.users(id);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'user_book_data_user_id_fkey'
    ) THEN
        ALTER TABLE public.user_book_data
            ADD CONSTRAINT user_book_data_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'user_book_data_book_id_fkey'
    ) THEN
        ALTER TABLE public.user_book_data
            ADD CONSTRAINT user_book_data_book_id_fkey FOREIGN KEY (book_id) REFERENCES public.books(id);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'user_book_ratings_user_id_fkey'
    ) THEN
        ALTER TABLE public.user_book_ratings
            ADD CONSTRAINT user_book_ratings_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'user_book_ratings_book_id_fkey'
    ) THEN
        ALTER TABLE public.user_book_ratings
            ADD CONSTRAINT user_book_ratings_book_id_fkey FOREIGN KEY (book_id) REFERENCES public.books(id);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'note_likes_user_id_fkey'
    ) THEN
        ALTER TABLE public.note_likes
            ADD CONSTRAINT note_likes_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'note_likes_shared_note_id_fkey'
    ) THEN
        ALTER TABLE public.note_likes
            ADD CONSTRAINT note_likes_shared_note_id_fkey FOREIGN KEY (shared_note_id) REFERENCES public.shared_notes(id);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'referral_transactions_referrer_user_id_fkey'
    ) THEN
        ALTER TABLE public.referral_transactions
            ADD CONSTRAINT referral_transactions_referrer_user_id_fkey FOREIGN KEY (referrer_user_id) REFERENCES public.users(id);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'referral_transactions_referee_user_id_fkey'
    ) THEN
        ALTER TABLE public.referral_transactions
            ADD CONSTRAINT referral_transactions_referee_user_id_fkey FOREIGN KEY (referee_user_id) REFERENCES public.users(id);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'referral_transactions_purchase_id_fkey'
    ) THEN
        ALTER TABLE public.referral_transactions
            ADD CONSTRAINT referral_transactions_purchase_id_fkey FOREIGN KEY (purchase_id) REFERENCES public.purchases(id);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'referral_transactions_book_id_fkey'
    ) THEN
        ALTER TABLE public.referral_transactions
            ADD CONSTRAINT referral_transactions_book_id_fkey FOREIGN KEY (book_id) REFERENCES public.books(id);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'shared_notes_created_by_fkey'
    ) THEN
        ALTER TABLE public.shared_notes
            ADD CONSTRAINT shared_notes_created_by_fkey FOREIGN KEY (created_by) REFERENCES auth.users(id);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'shared_notes_user_id_fkey'
    ) THEN
        ALTER TABLE public.shared_notes
            ADD CONSTRAINT shared_notes_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'shared_notes_book_id_fkey'
    ) THEN
        ALTER TABLE public.shared_notes
            ADD CONSTRAINT shared_notes_book_id_fkey FOREIGN KEY (book_id) REFERENCES public.books(id);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM pg_constraint
        WHERE conname = 'user_ai_preferences_user_id_fkey'
    ) THEN
        ALTER TABLE public.user_ai_preferences
            ADD CONSTRAINT user_ai_preferences_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
    END IF;
END $$;
